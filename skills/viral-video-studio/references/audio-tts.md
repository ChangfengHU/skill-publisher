...
Before enabling Qwen/DashScope, run `scripts/tts-credential-check.mjs`. If no usable key is found, follow `references/credential-handling.md` or run the install wizard:
